...
function mint(keypair, env, configAddress, uuid, rpcUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var mint, userKeyPair, anchorProgram, userTokenAccountAddress, _a, candyMachineAddress, candyMachine, remainingAccounts, signers, instructions, _b, _c, tokenAccount, transferAuthority, metadataAddress, masterEdition, _d, _e;
        var _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    return [4 /*yield*/, accounts_1.loadCandyProgram(userKeyPair, env, rpcUrl)];
                case 1:
