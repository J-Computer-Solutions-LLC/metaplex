...
programCommand('upload')
    ...
    var _a, number, keypair, env, cacheName, storage, ipfsInfuraProjectId, ipfsInfuraSecret, awsS3Bucket, retainAuthority, mutable, rpcUrl, ipfsCredentials, pngFileCount, jsonFileCount, parsedNumber, elemCount, startMs, warn, successful, endMs, timeTaken;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = cmd.opts(), number = _a.number, keypair = _a.keypair, env = _a.env, cacheName = _a.cacheName, storage = _a.storage, ipfsInfuraProjectId = _a.ipfsInfuraProjectId, ipfsInfuraSecret = _a.ipfsInfuraSecret, awsS3Bucket = _a.awsS3Bucket, retainAuthority = _a.retainAuthority, mutable = _a.mutable, rpcUrl = _a.rpcUrl;
                ...
                warn = false;
                _b.label = 1;
            case 1: return [4 /*yield*/, upload_1.upload(files, cacheName, env, keypair, elemCount, storage, retainAuthority, mutable, rpcUrl, ipfsCredentials, awsS3Bucket)];
            case 2:
                successful = _b.sent();
                if (successful) {
                    warn = false;
...
programCommand('show')
    ...
    .option('-r, --rpc-url <string>', 'custom rpc url since this is a heavy command')
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, keypair, env, cacheName, rpcUrl, cachePath, cacheContent, walletKeyPair, anchorProgram, _b, candyMachine, machine, e_1, config;
...
programCommand('create_candy_machine')
    ...
    .option('-r, --rpc-url <string>', 'custom rpc url since this is a heavy command')
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, keypair, env, price, cacheName, splToken, splTokenAccount, solTreasuryAccount, rpcUrl, parsedPrice, cacheContent, walletKeyPair, anchorProgram, wallet, remainingAccounts, splTokenKey, splTokenAccountKey, token, mintInfo, tokenAccount, config, _b, candyMachine, bump;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
